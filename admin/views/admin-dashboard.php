...
jQuery(document).ready(function($) {
    ...
    $('#days-filter').on('change', function() {
        ...
        if (value === 'custom') {
            ...
            window.location.href = '<?php echo esc_url(admin_url('admin.php?page=wc-all-cart-tracker')); ?>&days=' + value + '&per_page=<?php echo esc_js($per_page); ?>';
        }
    });
    ...
    $('#apply-custom-range').on('click', function() {
        ...
        window.location.href = '<?php echo esc_url(admin_url('admin.php?page=wc-all-cart-tracker')); ?>&days=custom&date_from=' + dateFrom + '&date_to=' + dateTo + '&per_page=<?php echo esc_js($per_page); ?>';
    });
