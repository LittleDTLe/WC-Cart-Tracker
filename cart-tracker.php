                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                            <div>
                                ...
                                <select id="days-filter" onchange="this.form.submit()" name="days" form="filter-form">
                                    <option value="7" <?php selected($days_filter, 7); ?>><?php echo esc_html__('Last 7 Days', 'wc-all-cart-tracker'); ?></option>
                                    <option value="30" <?php selected($days_filter, 30); ?>><?php echo esc_html__('Last 30 Days', 'wc-all-cart-tracker'); ?></option>
                                    <option value="60" <?php selected($days_filter, 60); ?>><?php echo esc_html__('Last 60 Days', 'wc-all-cart-tracker'); ?></option>
                                    <option value="90" <?php selected($days_filter, 90); ?>><?php echo esc_html__('Last 90 Days', 'wc-all-cart-tracker'); ?></option>
                                    <option value="365" <?php selected($days_filter, 365); ?>><?php echo esc_html__('Last Year', 'wc-all-cart-tracker'); ?></option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="status-filter" onchange="this.form.submit()" name="status" form="filter-form">
                                    <option value="all" <?php selected($status_filter, 'all'); ?>><?php echo esc_html__('All', 'wc-all-cart-tracker'); ?> (<?php echo esc_html($all_count); ?>)</option>
                                    <option value="converted" <?php selected($status_filter, 'converted'); ?>><?php echo esc_html__('Converted', 'wc-all-cart-tracker'); ?> (<?php echo esc_html($converted_count); ?>)</option>
                                    <option value="deleted" <?php selected($status_filter, 'deleted'); ?>><?php echo esc_html__('Deleted', 'wc-all-cart-tracker'); ?> (<?php echo esc_html($deleted_count); ?>)</option>
                                    <option value="abandoned" <?php selected($status_filter, 'abandoned'); ?>><?php echo esc_html__('Abandoned', 'wc-all-cart-tracker'); ?> (<?php echo esc_html($abandoned_count); ?>)</option>
                                    <option value="inactive" <?php selected($status_filter, 'inactive'); ?>><?php echo esc_html__('All Inactive', 'wc-all-cart-tracker'); ?></option>
                                </select>
                            </div>
                        </div>
                    ...
                    <table class="wp-list-table widefat fixed striped">
                        <thead>
                            <tr>
                                ...
                                <th class="sortable <?php echo $orderby === 'last_updated' ? 'sorted' : ''; ?> <?php echo strtolower($order); ?>">
                                    <a href="<?php echo esc_url(add_query_arg(array('orderby' => 'last_updated', 'order' => $orderby === 'last_updated' && $order === 'DESC' ? 'ASC' : 'DESC', 'days' => $days_filter, 'status' => $status_filter))); ?>">
                                        <?php echo esc_html__('Date', 'wc-all-cart-tracker'); ?>
                                        <span class="sorting-indicator"></span>
                                    </a>
                                </th>
                                <th class="sortable <?php echo $orderby === 'customer_email' ? 'sorted' : ''; ?> <?php echo strtolower($order); ?>">
                                    <a href="<?php echo esc_url(add_query_arg(array('orderby' => 'customer_email', 'order' => $orderby === 'customer_email' && $order === 'DESC' ? 'ASC' : 'DESC', 'days' => $days_filter, 'status' => $status_filter))); ?>">
                                        <?php echo esc_html__('Customer', 'wc-all-cart-tracker'); ?>
                                        <span class="sorting-indicator"></span>
                                    </a>
                                </th>
                                <th class="sortable <?php echo $orderby === 'cart_status' ? 'sorted' : ''; ?> <?php echo strtolower($order); ?>">
                                    <a href="<?php echo esc_url(add_query_arg(array('orderby' => 'cart_status', 'order' => $orderby === 'cart_status' && $order === 'DESC' ? 'ASC' : 'DESC', 'days' => $days_filter, 'status' => $status_filter))); ?>">
                                        <?php echo esc_html__('Status', 'wc-all-cart-tracker'); ?>
                                        <span class="sorting-indicator"></span>
                                    </a>
                                </th>
                                <th class="sortable <?php echo $orderby === 'cart_total' ? 'sorted' : ''; ?> <?php echo strtolower($order); ?>">
                                    <a href="<?php echo esc_url(add_query_arg(array('orderby' => 'cart_total', 'order' => $orderby === 'cart_total' && $order === 'DESC' ? 'ASC' : 'DESC', 'days' => $days_filter, 'status' => $status_filter))); ?>">
                                        <?php echo esc_html__('Cart Total', 'wc-all-cart-tracker'); ?>
                                        <span class="sorting-indicator"></span>
                                    </a>
                                </th>
                                    ...
                                    <?php foreach ($carts as $cart): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <span style="display: inline-block; padding: 3px 8px; background: <?php echo esc_attr($status_color); ?>; color: #fff; border-radius: 3px; font-size: 11px; font-weight: 600;">
